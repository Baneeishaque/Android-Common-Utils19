...
public abstract class LoginBaseJsonArrayCustomResponseHandlerActivity extends LoginBaseActivity {
    ...
    public void performHttpApiSelectTask() {
        ...
        HttpApiSelectTaskWrapper.executePostThenReturnJsonArrayWithoutErrorStatusCheck(configure_SELECT_USER_URL(), this, progressBar, scrollView, configureApplicationName(), configure_JSON_ARRAY_RESPONSE_HANDLER());
    }
