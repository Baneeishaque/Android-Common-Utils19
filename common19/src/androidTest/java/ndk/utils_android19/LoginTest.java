...
public class LoginTest {
    ...
    public ActivityTestRule<LoginBundleActivity> mActivityRule = new ActivityTestRule<LoginBundleActivity>(LoginBundleActivity.class) {
        ...
        protected Intent getActivityIntent() {
            ...
            return ActivityUtils19.constructIntentWithStringExtras(targetContext,
                    LoginBundleActivity.class,
                    new Pair[]{
                            new Pair<>(IntentExtendedDataItemNames.INTENT_EXTENDED_DATA_ITEM_NAME_APPLICATION_NAME, Application_Specification.APPLICATION_NAME),
                            new Pair<>(IntentExtendedDataItemNames.INTENT_EXTENDED_DATA_ITEM_NAME_NEXT_ACTIVITY_CLASS, "Splash_Version_OK"),
                            new Pair<>(IntentExtendedDataItemNames.INTENT_EXTENDED_DATA_ITEM_NAME_SELECT_USER_URL, "http://vfmob.com.md-in-64.webhostbox.net/wp-production/account_ledger_server/http_API/select_User.php")
                    }
            );
        }
    };
